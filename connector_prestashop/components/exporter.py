...
class PrestaShopBaseExporter(AbstractComponent):
    ...
    def __init__(self, working_context):
        super(PrestaShopBaseExporter, self).__init__(working_context)
        self.binding = None
    ...
    def _should_import(self):
        ...
        in PrestaShop and the last sync date in Odoo,
        ...
        # prestashop_date = datetime.strptime(record['updated_at'],
        #                                  PRESTASHOP_DATETIME_FORMAT)
        # return sync_date < prestashop_date

        # In our case, Odoo is the master
        return False
    ...
    def _after_export(self):
        """ Can do several actions after exporting a record on Prestashop """
        pass
...
class PrestaShopExporter(AbstractComponent):
    ...
    def __init__(self, working_context):
        super(PrestaShopExporter, self).__init__(working_context)
        self.binding = None
    ...
    def _retry_unique_violation(self):
        ...
        record created by :meth:`_export_dependency`), resulting in:
            ...
            constraint "prestashop_product_product_odoo_uniq"
    ...
    def _export_dependency(self, relation, binding_model,
        ...
        if wrap and hasattr(relation, binding_field):
            ...
            # prestashop.product.product and we are exporting it, but we need to
    ...
    def _run(self, fields=None):
        ...
        return _('Record exported with ID %s on PrestaShop.') % self.external_id
